    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            string[] rows = AoCUtils.GetInput(stopwatch, day: 1, puzzle: 1, title: "Historian Hysteria");  
            int total = 0;
            ...
            rows = AoCUtils.GetInput(stopwatch, day: 1, puzzle: 2, title: "Historian Hysteria");
            total = 0;

            for (int i = 0; i < list1.Count; i++)
            {
                total += list1[i] * list2.FindAll(x => x == list1[i]).Count;
            }
